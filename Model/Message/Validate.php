...
namespace Droppery\Core\Model\Message;

use Magento\Framework\Notification\MessageInterface;
use Magento\Framework\Phrase;
use Magento\Framework\UrlInterface;
use Droppery\Core\Helper\Validate as ValidateHelper;

/**
 * Class Validate
 * @package Droppery\Core\Model\Message
 */
class Validate implements MessageInterface
{
    ...
    public function getText()
    {
        ...
        return __(
            'One or more Droppery extensions are not validated. Click <a href="%1">here</a> to validate them.',
            $url
        );
    }
